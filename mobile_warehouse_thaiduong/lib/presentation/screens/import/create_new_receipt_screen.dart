...
class _CreateNewReceiptScreenState extends State<CreateNewReceiptScreen> {
  ...
  //
  String receiptId = '', lotId = '', poNumber = '';
                      ...
                      DropdownButton<Item>(
                        ...
                        onChanged: (Item? newValue) {
                          setState(() {
                            ...
                            print(itemsDropdownData.indexOf(selectedItem as Item));
                          });
                        },
            ...
            if (state is AddLotToGoodsReceiptStateSuccess ||
              ...
              return SizedBox(
                ...
                child: ListView.builder(
                    itemCount: itemlots.length,
                    itemBuilder: (BuildContext context, int index) {
                      return GestureDetector(
                        onTap: (() {
                     //     _showForm(itemlots[index].itemName, []);
                        }),
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            color: Constants.buttonColor,
                            child: Text(itemlots[index].itemName),
                          ),
                        ),
                      );
                    }),
